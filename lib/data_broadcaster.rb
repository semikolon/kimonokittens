...
class DataBroadcaster
  ...
  def start
    ...
    @threads << periodic(60) { fetch_and_publish('schedule_data', "#{@base_url}/api/heatpump/schedule?skip_sms=true") }
  ...
  def initial_broadcast
    ...
    Thread.new do
      ...
      fetch_and_publish('schedule_data', "#{@base_url}/api/heatpump/schedule?skip_sms=true")
