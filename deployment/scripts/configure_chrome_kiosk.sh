...
echo ""
echo "  2. Restart kiosk:"
echo "     machinectl shell $SERVICE_USER@ /usr/bin/systemctl --user restart kimonokittens-kiosk"
echo ""
echo "Or simply reboot the system."
echo ""
echo -e "${GREEN}Note: 120% zoom + 2024 NVIDIA GPU acceleration for smooth WebGL rendering${NC}"
